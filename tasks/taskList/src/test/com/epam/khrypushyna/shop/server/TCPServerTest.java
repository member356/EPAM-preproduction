...
public class TCPServerTest {
    ...
    private static final String REQUEST_COUNT = "127.0.0.1:8081?getcount\r\n\r\n";
    private static final String REQUEST_ITEM = "127.0.0.1:8081?getitem=1\r\n\r\n";
    ...
    private TCPHandler handler = new TCPHandler(socketMock, catalogMock);
    ...
    public void shouldReturnPriceOfItemWhenGetItem() throws IOException {
        ...
        verify(socketMock).getOutputStream();
        String resp = String.valueOf(socketMock.getOutputStream());
        assertTrue(resp.endsWith("price = 900"));
    }
